...
# split data into train/test sample, scaling = True 
...
k=5
cv=StratifiedKFold(n_splits=k,shuffle=True,random_state=42) # Stratified cross-validation again, k = 5
"""
...
write_output_to_csv(results_df,subdirectory="LR",file_name="abandond_run.csv",string_to_write=string_to_write)
