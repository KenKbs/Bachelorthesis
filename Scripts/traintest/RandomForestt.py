...
def run_RF_traintest(shading=True,num_iterations=100):
    ...
    #Get train_time from GS
    train_time_GS=get_GS_traintime(to_file="RF",shading=shading)
    
    #Add train train-time of Gridsearch for best-model
    ...
    #Append heading fit time to row_labels
