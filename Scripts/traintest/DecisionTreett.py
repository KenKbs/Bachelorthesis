# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 11:45:46 2024
...
#%% main function
def run_DT_traintest(shading=True,num_iterations=100):
    """
    ...
    #Get train time from GridSearch
    train_time_GS=get_GS_traintime(to_file="DT", shading=shading)
