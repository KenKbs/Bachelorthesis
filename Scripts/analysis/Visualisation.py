...
def plot_confusion_matrix2(cm_LR, cm_DT, cm_RF, cm_SVM, cm_NN,
                          target_names=None,
                          to_file=False,
                          show_plot=False,
                          shading=True,
...
# Define a custom colormap with light colors
colors = [(0.8, 0.8, 1), (0.9, 0.9, 1), (1, 1, 1)]  # light blue to white
light_cmap = LinearSegmentedColormap.from_list("light_cmap", colors)
...
def plot_confusion_matrix3(cm_LR, cm_DT, cm_RF, cm_SVM, cm_NN,
                          target_names=None,
                          to_file=False,
                          show_plot=False,
                          shading=True,
    ...
    # Use the provided cmap or the custom light colormap
    if cmap is None:
        cmap = light_cmap
...
plot_confusion_matrix3(cm_LR, cm_DT, cm_RF, cm_SVM, cm_NN)
